...
public class InterviewQuestionController {
    ...
    @PostMapping
    public ChatQuestionResponse createQuestion(@Valid @RequestBody InterviewQuestionRequest request) {
        return interviewQuestionService.createQuestion(request);
    }

    @GetMapping("/{questionId}")
    public ChatQuestionResponse getQuestion(@PathVariable Long questionId) {
